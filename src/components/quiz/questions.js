    ...
    return (
        <form>
            <Grid container justify="center">
                <Grid item xs={7}>
                    <div className="topQuiz">
                        ...
                        <div className="tripNameBox">
                            ...
                            <input name="tripName" type="text" value={userAnswer.tripName} onChange={handleControlledInputChange} required autoFocus />
                        </div>
                        <div className="tripTypeBox">
                            ...
                            <select className="typeDropdown" name="tripType" value={userAnswer.tripType} onChange={handleControlledInputChange}>
                                <option value="" defaultValue hidden>Choose a trip type</option>
                ...
                <Grid item xs={9}>
                    <div className="question1box" data-aos='fade-up'>
                        <p>1/6</p>
                        <FormControl component="fieldset">
                            <FormLabel htmlFor="response1" component="legend">Which acitvity is a must-do on your vacation:</FormLabel>
                            <RadioGroup className={classes.formControl} value={userAnswer.response1} onChange={handleControlledInputChange} required autoFocus name="response1">
                ...
                <Grid item xs={9}>
                    <div className="question2" data-aos='fade-up'>
                        <p>2/6</p>
                        <FormControl component="fieldset">
                            <FormLabel htmlFor="response2" component="legend">Which is your dream accomadation:</FormLabel>
                            <RadioGroup className={classes.formControl} value={userAnswer.response2} onChange={handleControlledInputChange} required autoFocus name="response2" >
                                <Grid container direction="row" justify="center" alignItems="center">
                                    <Grid item xs={6}>
                                        <div className="question1Answers">
                ...
                <Grid item xs={8}>
                    <div className="question3" data-aos='fade-up'>
                        <p>3/6</p>
                        <FormControl component="fieldset">
                            <FormLabel htmlFor="response3" component="legend">On a vacation, you want to be:</FormLabel>
                            <RadioGroup className={classes.formControl} value={userAnswer.response3} onChange={handleControlledInputChange} required autoFocus name="response3" >
                                <Grid container direction="row" justify="center" alignItems="center">
                                    <Grid item xs={6}>
                                        <div className="question1Answers">
                ...
                <Grid item xs={8}>
                    <div className="question5 show-on-scroll" data-aos='fade-up'>
                        <p>5/6</p>
                        <FormControl component="fieldset">
                            <FormLabel htmlFor="response5" component="legend">What do you want to eat on your trip?</FormLabel>
                            <RadioGroup className={classes.formControl} value={userAnswer.response5} required autoFocus onChange={handleControlledInputChange} name="response5" >
                                <Grid container direction="row" justify="center" alignItems="center">
                                    <Grid item xs={6}>
                                        <div className="question1Answers">
                ...
                <Grid item xs={9}>
                    <div className="question6 show-on-scroll" data-aos='fade-up'>
                        <p>6/6</p>
                        <FormControl component="fieldset">
                            <FormLabel htmlFor="response6" component="legend">What is your trip budget?</FormLabel>
                            <RadioGroup className={classes.formControl} value={userAnswer.response6} required autoFocus onChange={handleControlledInputChange} name="response6" >
